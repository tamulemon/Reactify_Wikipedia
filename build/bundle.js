	...
	render: function() {
		return (
			React.createElement("main", null, 
				...
				React.createElement(CentralFeatured, null), 
...
React.render(React.createElement(App, {appName: "wikipedia"}), document.body);		

},{"./central_features.jsx":2,"./header.jsx":4,"./search_container.jsx":5,"react":161}],2:[function(require,module,exports){
var React = require('react');
var FeaturedLan = require('./featured_lan.jsx');

var CentralFeatureList = module.exports = React.createClass({displayName: "exports",
	...
	render: function() {
		var lanList = this.state.featuredLans.map(function(oneLan) {
			// skip the list 
			return React.createElement(FeaturedLan, {lan: oneLan})
		});
...
},{"./featured_lan.jsx":3,"react":161}],3:[function(require,module,exports){
var React = require('react');

var FeaturedLan = module.exports = React.createClass({displayName: "exports",
	render: function() {
		return (
			React.createElement("li", null, 
				React.createElement("h3", null, this.props.lan.lan), 
				React.createElement("p", null, this.props.lan.des), 
				React.createElement("p", null, this.props.lan.articles)
			)
		)
	}
});
...
var Header = module.exports = React.createClass({displayName: "exports",
	render: function() {
		return (
			React.createElement("h1", null, "WIKIPEDIA")
		)
	}
});
...
var SearchContainer = module.exports = React.createClass({displayName: "exports",
	render: function() {
		return (
			React.createElement("form", {action: "//www.wikipedia.org/search-redirect.php"}, 
			React.createElement("label", null, "Search: "), 
				React.createElement("input", {id: "searchInput", name: "search", type: "search", size: "20", autofocus: "autofocus", dir: "auto", results: "10"}), 
			React.createElement("input", {class: "formBtn", type: "submit", value: "→", name: "go"})
			)
		)
	}
});
